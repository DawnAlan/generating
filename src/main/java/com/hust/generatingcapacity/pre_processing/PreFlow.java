...
//        String fileName = "C:\\Users\\12566\\Desktop\\大渡河数据\\径流资料\\预报资料\\相似性预报-日.xlsx";
//        Object[][] data1 = ExcelUtils.readExcel(fileName, "Sheet1");
//        Object[][] data2 = ExcelUtils.readExcel(fileName, "Sheet2");
//        Map<String, Integer> splitsPositions = Map.of("split1", 0, "time", 2);
...
//        splits.add(30000027);
//        splits.add(30000028);
//        String fileName2 = "C:\\Users\\12566\\Desktop\\大渡河数据\\径流资料\\预报资料\\大渡河24年汛期相似性预报-日.xlsx";
...
//    }
    ...
    public static void main(String[] args) {
        ...
        String fileName = "C:\\Users\\12566\\Desktop\\大渡河数据\\径流资料\\预报资料\\大渡河24年汛期概率预报-日.xlsx";
        String resultName = "C:\\Users\\12566\\Desktop\\大渡河数据\\径流资料\\预报资料\\大渡河24年汛期不同预见期概率预报-AR-日.xlsx";
        List<String> sheets = ExcelUtils.checkSheetsInExcel(fileName);
        Integer[] preDays = new Integer[]{1, 3, 10};
        Date start = sdf.parse("2024-05-31");
        Date end = sdf.parse("2024-10-01");
        ...
        for (int i = 0; i < sheets.size(); i++) {
            ...
            for (int j = 0; j < preDays.length; j++) {
                ...
                for (int k = 1; k < data.length; k++) {
                    ...
                    if (matched && TimeUtils.dateCompare(date, (Date) data[k][1], "日")) {
                        continue;
                    }
                    if (!TimeUtils.dateCompare(date, (Date) data[k][1], "日")) {
                        matched = false;
                    }
                    if (((Date) data[k][1]).after(date)) {
                        int blank = TimeUtils.getDateDuration(date,(Date) data[k][1],"日");
